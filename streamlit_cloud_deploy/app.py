...
DEEPSEEK_API_BASE = st.secrets.get("DEEPSEEK_API_BASE", "https://api.deepseek.com/v1")

# 阿里云DashScope配置（通义千问）- 主要使用
DASHSCOPE_API_KEY = st.secrets.get("DASHSCOPE_API_KEY", "")
DASHSCOPE_MODEL = st.secrets.get("DASHSCOPE_MODEL", "qwen-plus")
DASHSCOPE_API_BASE = st.secrets.get("DASHSCOPE_API_BASE", "https://dashscope.aliyuncs.com/compatible-mode/v1")
...
DEFAULT_LLM = st.secrets.get("DEFAULT_LLM", "dashscope")
